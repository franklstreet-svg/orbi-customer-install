...
Orbi is your AI for three jobs: **your phone receptionist**, **your website chat host**, and **your personal assistant** on your own computer. Everything below works from the *Ask Orbi* tab in this dashboard — type a request or use the microphone.
...
1. Type *"Show me my day"* in **Ask Orbi** — she'll pull together calendar + tasks + unread messages.
...
| Auto-reply | Turn on **Settings → Email → Auto-reply** so Orbi answers routine messages in your voice |
...
All files live in your `Orbi/` folder. Nothing leaves your computer.
...
- Click the mic icon, or say *"Hey Orbi"* (if wake-word is on)
- She'll listen, answer with voice, and keep her ear open for follow-ups
- Say *"goodbye"* or *"I'm good"* when you're done

## Catalog & inventory

If you sell things, drop a CSV / Excel / Google Sheet in **Files → Catalog** and Orbi will:
...
Read-only — Orbi never creates charges or refunds.
...
- **Personality** — pick how Orbi talks (friendly / formal / brisk). Affects every channel.
- **Style learning** — Orbi watches how YOU write emails and matches your voice over time.
- **Notifications** — choose how she pings you when something needs attention.
- **Backups** — your data snapshots to `Orbi/backups/` automatically. You can also export a full ZIP from **Settings → Data**.
- **Voice** — pick Orbi's voice (12 to choose from). Test it from Settings.
...
- **Orbi seems slow** — check the connection light in the header. Green = full brain, yellow = backup brain, red = offline (still works locally, just less smart).
...
- **The phone or chat went down** — Orbi's watchdog should restart her automatically. If it doesn't, run `orbi-restart` from Terminal/PowerShell.
...
*This guide is updated as Orbi grows. Last updated: 2026-05-27.*
